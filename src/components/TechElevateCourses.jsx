        ...
        <div className="bg-[#ecffef] rounded-md  overflow-hidden transform transition duration-300 hover:scale-101 mb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
            ...
            <div className="lg:col-span-5 p-6 lg:p-8 flex flex-col justify-between">
              <div>
                <h3 className="text-xl lg:text-2xl font-bold mb-4">{course.title}</h3>
                <p className="text-gray-600 text-sm lg:text-base">{course.description}</p>
              </div>
              ...
              <div className="flex flex-col xs:flex-row gap-3 mt-6">
                <a
                  ...
                  className="flex items-center justify-center px-4 lg:px-6 py-2 lg:py-3 bg-primary text-white text-sm lg:text-base  hover:bg-[#007B5A] transition-colors"
                >
                  Enroll Now
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center px-4 lg:px-6 py-2 lg:py-3  bg-[#1A9AB1] text-white text-sm lg:text-base  hover:bg-[#027083] transition-colors"
                >
                  Brochure
                  <ArrowUpRight className="ml-2 h-4 w-4 lg:h-5 lg:w-5" />
                </a>
  ...
  return (
    <section className="py-8 lg:py-16 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl lg:text-4xl font-bold text-center mb-8 lg:mb-12">Our Courses</h2>
