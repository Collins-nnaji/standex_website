          ...
          >
            ...
            >
             <motion.a 
                ...
                className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-primary hover:bg-[#007B5A] text-white text-sm sm:text-base font-medium transition-colors duration-300 ease-in-out"
